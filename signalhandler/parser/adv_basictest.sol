...
contract A {
    ...
    function binding() public {
        ...
        AlertUpdate.bind(this_address, "Alert1(bool,bytes32,address)", 0.46);
    }
    ...
    function detaching() public view {
        address this_address = address(this);
        AlertUpdate.detach(this_address, "Alert1(bool,bytes32,address)");
    }

    constructor () {
        address this_address = address(this);
        AlertUpdate.bind(this_address, "Alert1(bool,bytes32,address)", 0.3);
        AdvAlertUpdate.bind(this_address, "Alert2(bool,bytes32,address)", 0.78);
    }
}
