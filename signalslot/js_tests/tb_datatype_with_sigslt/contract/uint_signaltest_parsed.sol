...
contract A {
	...
	bytes4 private priceFeedUpdate_data;
	...
	function set_priceFeedUpdate_data(bytes4  dataSet) private {
    ...
    function emitfunc(bytes4  DataSent) public {
        //////////////////////////////////////////////////////////////////////////////////////////////////
        // GENERATED BY SIGNALSLOT PARSER
...
contract B {
    ...
    function priceReceive() private {
        priceReceive_key = keccak256("priceReceive_func(uint32)");
        assembly {
            sstore(priceReceive_status_slot, createslot(1, 10, 30000, sload(priceReceive_key_slot)))
        }
    }
    //////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    function priceReceive_func(uint32 obj) public {
        LocalPriceSum = ~ obj;
    }
