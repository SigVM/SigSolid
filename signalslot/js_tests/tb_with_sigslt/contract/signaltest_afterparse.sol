...
contract A {
	...
	bytes3 private priceFeedUpdate_data;
	...
	function set_priceFeedUpdate_data(bytes3 dataSet) private {
    ...
    // Generated variables that represent the signal
	bytes32 private random_dataslot;//the data pointer is NULL
    ...
    // Get the data slot
    function get_random_dataslot() private view returns (bytes32 dataslot) {
    ...
    function emitfunc(bytes3 DataSent) public {
		...
		assembly {
			mstore(0x40, emitsig(this_emitsig_priceFeedUpdate_key, ONE_HOUR, this_emitsig_priceFeedUpdate_dataslot, this_emitsig_priceFeedUpdate_argc))
	    }
        //////////////////////////////////////////////////////////////////////////////////////////////////
...
contract B {
    ...
    function detachfunc() public {
        ...
        // Get the signal key
		bytes32 dut_detach_priceFeedUpdate_key = dut.get_priceFeedUpdate_key();
        // Get the address
