...
contract PriceOracleBuffer {
   ...
   SendUpdate();
		...
		assembly {
			mstore(0x40, bindslot(this_address, this_PriceFeedUpdate_key, sload(SendUpdate_key_slot)))
	    }
        //////////////////////////////////////////////////////////////////////////////////////////////////
		...
		assembly {
			mstore(0x40, emitsig(this_PriceFeedUpdate_key, 0, this_PriceFeedUpdate_dataslot, this_PriceFeedUpdate_argc))
	    }
        //////////////////////////////////////////////////////////////////////////////////////////////////
...
contract ReceiverA {
   ...
   RecievePrice();
        ...
        // Original Code:
        // RecievePrice.bind(oracle.)

        // Convert to address
		address oracle_address = address(oracle);
        // Get signal key from emitter contract
		bytes32 oracle__key = oracle.get__key();
        // Use assembly to bind slot to signal
		assembly {
			mstore(0x40, bindslot(oracle_address, oracle__key, sload(RecievePrice_key_slot)))
	    }
        //////////////////////////////////////////////////////////////////////////////////////////////////
